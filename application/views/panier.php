...
include 'carousel.php'; ?>
    ...
    <div class="container">
        <h1 class="d-flex justify-content-center">Mon panier</h1>
        <hr>
        <?php
        ...
        { ?>
            ...
            <div class="d-flex justify-content-between">
                ...
                <td>
                        ...
                        <button type="button" class="btn btn-rounded btn-success btn-sm border-success" data-toggle="popover" title="Je vous remercie."
                    data-content="Mais je veux pas votre argent">Valider votre commande
                        </button>
