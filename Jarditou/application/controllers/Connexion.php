...
class Connexion extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('pseudo', 'Pseudo', 'trim|required|is_unique[users.pseudo]', array('required' => "Veuillez insirer un nom d'utilisateur"));
        $this->form_validation->set_rules('mail', 'E-mail', 'trim|required|valid_email', array('required' => "Veuillez nous fournir un E-mail"));
        $this->form_validation->set_rules('mot_de_passe', 'Mot de passe', 'trim|required', array('required' => "Veuillez insirer un mot de passe"));
        $this->form_validation->set_rules('passwordC', 'Confirmation mot de passe', 'trim|required', array('required' => "Veuillez remplir avec un mot de passe identique"));
